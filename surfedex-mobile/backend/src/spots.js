...
module.exports = [
  ...
  // IDs idénticos a los del frontend (data/spots.js, area "ast-este").
  {
    ...
    waveFactor: 0.7, score: { swellIdeal: [1, 2.5], periodIdeal: 12 }
  },
  {
    id: "la-nora",
    name: "La Ñora",
    ...
    waveFactor: 0.6, score: { swellIdeal: [1, 2.5], periodIdeal: 12 }
  },
  {
    id: "custom-mpsuiolb",
    name: "Rodiles",
    ...
    waveFactor: 0.75, score: { swellIdeal: [1, 3], periodIdeal: 13 }
  },
  {
    id: "custom-mpsud51b",
    name: "Vega",
    ...
    waveFactor: 0.85, score: { swellIdeal: [1, 3], periodIdeal: 13 }
  },
  {
    id: "custom-mpsu7cla",
    name: "Andrín",
    ...
    waveFactor: 0.75, score: { swellIdeal: [1, 2.5], periodIdeal: 12 }
  },
  ...
  { id: "custom-mpswn3ha", name: "Playa de España", latitude: 43.54599, longitude: -5.52907, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.5, score: { swellIdeal: [1, 2.5], periodIdeal: 12 } },
  { id: "custom-mpswt1ni", name: "Merón", latitude: 43.54432, longitude: -5.49411, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.85, score: { swellIdeal: [1, 2], periodIdeal: 11 } },
  { id: "custom-mpsxedcm", name: "La Espasa", latitude: 43.47486, longitude: -5.21639, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.8, score: { swellIdeal: [1, 2], periodIdeal: 11 } },
  { id: "custom-mpsxgbby", name: "Arenal de Moris", latitude: 43.47539, longitude: -5.1731, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.8, score: { swellIdeal: [1, 2], periodIdeal: 12 } },
  { id: "custom-mpsxiv0u", name: "Santa Marina", latitude: 43.46614, longitude: -5.06612, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.8, score: { swellIdeal: [1, 2.5], periodIdeal: 12 } },
  { id: "custom-mpsxmluu", name: "San Antolín", latitude: 43.44631, longitude: -4.87852, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.9, score: { swellIdeal: [1.5, 3], periodIdeal: 13 } },
  { id: "custom-mpsxq9cm", name: "Torimbia", latitude: 43.45101, longitude: -4.87129, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.5, score: { swellIdeal: [1.5, 2], periodIdeal: 11 } },
  { id: "custom-mpsxulha", name: "Playa de Barro", latitude: 43.44087, longitude: -4.8337, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.4, score: { swellIdeal: [1.5, 2.5], periodIdeal: 11 } },
  { id: "custom-mpsxxjw6", name: "Ballota", latitude: 43.41391, longitude: -4.71493, country: "ES", region: "Asturias", waveType: "Beach break / mixto", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.6, score: { swellIdeal: [1, 2], periodIdeal: 11 } },
  { id: "custom-mpsy1puu", name: "Vidiago", latitude: 43.40772, longitude: -4.6685, country: "ES", region: "Asturias", waveType: "Beach break / mixto", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.7, score: { swellIdeal: [1, 2.5], periodIdeal: 11 } },
  { id: "custom-mpsy4a66", name: "La Franca", latitude: 43.39864, longitude: -4.58227, country: "ES", region: "Asturias", waveType: "Beach break (desembocadura)", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.3, score: { swellIdeal: [1, 2.5], periodIdeal: 12 } },
  ...
  { id: "aguilar", name: "Aguilar", latitude: 43.55817, longitude: -6.09306, country: "ES", region: "Asturias", waveType: "Beach break / reef", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.6, score: { swellIdeal: [1, 3], periodIdeal: 12 } },
  { id: "cadavedo", name: "Cadavedo (La Ribeirona)", latitude: 43.5523, longitude: -6.3725, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSW","SW"], waveFactor: 0.3, score: { swellIdeal: [1, 2.5], periodIdeal: 12 } },
  { id: "otur", name: "Otur", latitude: 43.55351, longitude: -6.5979, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.65, score: { swellIdeal: [1, 2.5], periodIdeal: 12 } },
  { id: "barayo", name: "Barayo", latitude: 43.56122, longitude: -6.61413, country: "ES", region: "Asturias", waveType: "Beach break (desembocadura)", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSW","SW"], waveFactor: 0.7, score: { swellIdeal: [1, 3], periodIdeal: 12 } },
  { id: "frejulfe", name: "Freijulfe", latitude: 43.5593, longitude: -6.6762, country: "ES", region: "Asturias", waveType: "Beach break (desembocadura)", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSW","SW"], waveFactor: 0.9, score: { swellIdeal: [1, 2.5], periodIdeal: 12 } },
  { id: "navia", name: "Navia", latitude: 43.5549, longitude: -6.7231, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.6, score: { swellIdeal: [1, 2.5], periodIdeal: 12 } },
  { id: "tapia", name: "Tapia de Casariego", latitude: 43.5678, longitude: -6.9490, country: "ES", region: "Asturias", waveType: "Beach break / reef", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSW","SW"], waveFactor: 0.85, score: { swellIdeal: [1, 3], periodIdeal: 13 } },
  { id: "penarronda", name: "Peñarronda", latitude: 43.5533, longitude: -6.9970, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSW","SW"], waveFactor: 0.95, score: { swellIdeal: [1, 3], periodIdeal: 12 } },
  { id: "custom-mpsrsykc", name: "Cueva", latitude: 43.55096, longitude: -6.47364, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.7, score: { swellIdeal: [1, 2.5], periodIdeal: 12 } },
  { id: "custom-mpsrz0k3", name: "La Concha de Artedo", latitude: 43.56445, longitude: -6.18839, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.42, score: { swellIdeal: [1, 2.5], periodIdeal: 11 } },
  { id: "custom-mpss0cx1", name: "San Pedro", latitude: 43.57877, longitude: -6.22118, country: "ES", region: "Asturias", waveType: "Beach break", bestSwellDirection: ["NW","NNW","N"], bestWindDirection: ["S","SSE","SE"], waveFactor: 0.42, score: { swellIdeal: [1, 2.5], periodIdeal: 11 } },
