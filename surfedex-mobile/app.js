...
(function () {
  ...
  const WEBCAMS = {
    ...
    "la-nora": {
      type: "iframe",
      url: "https://rtsp.me/embed/5yiDFRQT/",
    ...
    "custom-mpsuiolb": {
      type: "iframe",
      url: "https://rtsp.me/embed/BRhbQzb9/",
    ...
    "custom-mpsxedcm": {
      type: "iframe",
      url: "https://rtsp.me/embed/5ByRFKFk/",
    ...
    "custom-mpsxgbby": {
      type: "iframe",
      url: "https://rtsp.me/embed/Shy68RNk/",
    ...
    "custom-mpsud51b": {
      type: "iframe",
      url: "https://rtsp.me/embed/9d6iFr5a/",
    ...
    "custom-mpsxiv0u": {
      type: "iframe",
      url: "https://rtsp.me/embed/YBFFAhDY/",
  ...
  // Capa SATÉLITE (Esri World Imagery) — ÚNICA vista del mapa.
  ...
  function renderPanel() {
    ...
    if (state.level === "spot") {
      ...
      let fcInner;
      const sffPaneHTML = `<div class="sff" id="sff-mount"><div class="sfc-loading">Cargando…</div></div>`;
      if (useSFC && wgId) {
      ...
      // (Windguru solo admite un widget activo a la vez).
      {
        ...
        function showSource(src) {
          ...
          if (src === "sfc") {
            ...
            if (!sffMounted) {
              window.SurfedexForecast.mountAlt(s, fcBody.querySelector("#sff-mount"));
              sffMounted = true;
            }
          } else {
            mountWg();
